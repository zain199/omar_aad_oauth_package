import 'package:omar_aad_oauth/helper/choose_oauth.dart'
    // ignore: uri_does_not_exist
    if (dart.library.io) 'package:omar_aad_oauth/helper/mobile_oauth.dart'
    // ignore: uri_does_not_exist
    if (dart.library.html) 'package:omar_aad_oauth/helper/web_oauth.dart';
import 'package:omar_aad_oauth/model/config.dart';
import 'package:omar_aad_oauth/model/failure.dart';
import 'package:omar_aad_oauth/model/token.dart';
